...
public final class FelUtil {
    ...
    public static boolean evaluation(String expression, Map<String, Object> context) {
        ...
        Expression compiledExpression = getCompiledExpression(expression, context, true);
        Object result = compiledExpression.eval(context);
        return result.toString().equals("true");
    }

    private static Expression getCompiledExpression(final String expression, final Map<String, Object> context,
